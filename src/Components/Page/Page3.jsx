      ...
      <div className="flex flex-row my-10">
        ...
        >
          <div className="flex-1 hover:bg-slate-400 rounded-xl">
            <div className="w-96 h-80 flex flex-row mt-3">
              ...
              <img
                ...
                src="https://i.ibb.co/XCQKvvF/canon-color-photo-printer-bd6.png"
                alt=""
              />
            </div>
          ...
          <div className="flex-1 ml-5">
            ...
            <div className="flex flex-col ">
              <h1 className="font-bold text-2xl mb-3">Cannon Photo Printer </h1>
              ...
              <p className="mt-3 mb-2">
                The image program PRO series printers inherit the red line from
                the EOS series – a symbol of exceptional quality. With
                crystal-fidelity, you can extract greatest dynamic range,
                accurate colour expression and maximum sharpness, bringing
                images from camera to print effortlessly for hobbyists and
                professionals alike.
              </p>
              {visible && (
        ...
        >
          <div className="flex-1 hover:bg-slate-400 rounded-xl">
            <div className="w-96 h-80 flex flex-row ">
              {/* <p className="w-10 ml-3 h-10 rounded-full bg-orange-400 mt-4 -p-2 text-3xl text-white text-center items-center">-5</p> */}
              <img
                className="w-80 h-72 mt-10 ml-5  hover:bg-slate-400"
                src="https://i.ibb.co/SRDvrzS/camera-icon-reality-icons-softiconsm-29.png"
                alt=""
              />
            </div>
          ...
          <div className="flex-1 ml-5">
            ...
            <div className="flex flex-col ">
              <h1 className="font-bold text-2xl mb-3">Cannon LiDE 120</h1>
              <h1 className="flex flex-row text-justify text-orange-500 text-2xl font-semibold mb-3">
                <PiCurrencyDollarBold className="my-1 mr-1" />
                760{" "}
              </h1>
              <p className="mt-3 mb-2">
                Via optical viewfinder: 9-point Center AF point is AF cross-type
                supporting f/5.6. Center AF point is vertical line-sensitive
                supporting f/2.8. Other AF points are vertical line-sensitive or
                horizontal line-sensitive AF supporting f/5.6. 2
              </p>
              {visible2 && (
                <button className="w-3/4  my-7 bg-blue-500 p-2 shadow-xl rounded-xl justify-center hover:bg-orange-400">
                  Add To Cart
